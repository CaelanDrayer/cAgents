...
### Reads
- `cagents-memory/{inst_id}/workflow/strategic_plan.yaml`
- `cagents-memory/{inst_id}/status.yaml`
- `cagents-memory/_system/capacity/`

### Writes
- `cagents-memory/{inst_id}/decisions/em_risk_assessment.yaml`
- `cagents-memory/{inst_id}/decisions/em_go_no_go.yaml`
- `cagents-memory/_system/decisions/priority_arbitration_*.yaml`
- `cagents-memory/_communication/hitl/escalation_*.yaml`
