...
- Campus recruiting program design
- Diversity recruiting initiatives
- Employer brand and candidate experience enhancements
...
- **Write**: `Agent_Memory/{instruction_id}/outputs/partial/recruiting_strategy.yaml`
