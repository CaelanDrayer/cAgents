...
For cAgents' 57 agents + 4 skills (post-v12.20.0 catalog consolidation; post-v12.2.0 `/org` removal), a hypothetical converter would produce:
...
- **Maintenance cost is the binding constraint**: cAgents' competitive advantage is depth (57 agents + state-machine pipeline + reviewer loops), not breadth across tools.
