...
Five minutes from install to your first orchestrated result. This guide reflects **v12.20.0 current** — 60 agents across 9 builder-role archetypes (post-v12.20.0 catalog consolidation; 42 routable + 16 core) and 4 user-invocable skills (`/designer`, `/helper`, `/run`, `/team`).
