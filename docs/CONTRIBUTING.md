...
cd cAgents
npm install
npm test          # 1514+ Vitest tests across 179+ files
```
...
```bash
npm test                    # All 1514+ Vitest tests across 179+ files (hooks + config + regression)
