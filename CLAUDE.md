...
**Tests**: `npm test` runs 1550+ Vitest tests across 184+ files (hooks + config validation + regression tests; static lower-bound — actual runtime count is higher because `it.each` rows expand to multiple tests)
**Version**: 12.46.0
