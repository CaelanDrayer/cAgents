...
**Tests**: `npm test` runs 1586+ Vitest tests across 186+ files (hooks + config validation + regression tests; static lower-bound — actual runtime count is higher because `it.each` rows expand to multiple tests)
**Version**: 12.50.1
