...
**Tests**: `npm test` runs 1277+ Vitest tests across 148+ files (hooks + config validation + regression tests; static lower-bound — actual runtime count is higher because `it.each` rows expand to multiple tests)
**Version**: 12.18.0
