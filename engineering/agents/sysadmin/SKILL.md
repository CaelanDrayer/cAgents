...
- `Agent_Memory/_communication/inbox/sysadmin/` - Deployment requests, alerts

**Writes**:
- `Agent_Memory/{instruction_id}/outputs/partial/deployment_report_{timestamp}.yaml`
- `Agent_Memory/{instruction_id}/decisions/{timestamp}_sysadmin.yaml`
