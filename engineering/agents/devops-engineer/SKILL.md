...
- `Agent_Memory/_communication/inbox/devops-engineer/` - Pipeline requests, build failures

**Writes**:
- `Agent_Memory/{instruction_id}/outputs/partial/pipeline_config_{timestamp}.yaml`
- `Agent_Memory/{instruction_id}/decisions/{timestamp}_devops-engineer.yaml`
