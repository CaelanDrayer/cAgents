...
```bash
mkdir -p cagents-memory/_system/domains/{domain_name}
```

### Step 2: Copy Templates

```bash
cd cagents-memory/_system/domains/_template
...
- Ensure folder named correctly: `cagents-memory/_system/domains/{domain_name}/`
