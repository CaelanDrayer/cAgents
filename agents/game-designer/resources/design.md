> Mode `design` of `game-designer` — relocated verbatim from `agents/game-designer.md` (zero-loss consolidation).
...
See @resources/design-mechanics-framework.md for design patterns.
See @resources/design-coordination-questions.md for team coordination.
See @resources/design-best-practices.md for quality standards and anti-patterns.
