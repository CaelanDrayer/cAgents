...
See @backend-developer/resources/api.md for the api mode full playbook (REST/GraphQL, authentication, caching, integrations).
See @backend-developer/resources/database.md for the database mode full playbook (DBA, schema design, query optimization, migrations).
See @backend-developer/resources/engine.md for the engine mode full playbook (engine architecture, rendering, platform optimization).
See @backend-developer/resources/game.md for the game mode full playbook (gameplay programming, AI systems, physics integration).
