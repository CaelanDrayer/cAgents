...
See @task-state/resources/state.md for the state mode's full playbook (CSV schema, operations, context savings table).

See @task-state/resources/merge.md for the merge mode's full playbook (splitting strategies, workflow, sizing rules).
