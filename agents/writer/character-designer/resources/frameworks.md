...
Detailed reference for the wound-want-need framework, contradiction, character-driven plotting, ensemble dynamics, revelation, archetype/subversion, arc types, and anti-patterns. The SKILL.md body keeps the core philosophy and a compact framework summary; this file carries the full treatment.
...
1. **What others say about them** (weakest -- could be wrong, biased, or incomplete)
2. **What they say about themselves** (unreliable -- people lie to themselves)
3. **What they think** (closer to truth, but thoughts can be self-deceptive)
4. **What they do when observed** (behavior under social pressure)
5. **What they do when not observed** (behavior without audience)
6. **What they do under extreme pressure** (their truest self, revealed when all pretense is stripped away -- strongest)
