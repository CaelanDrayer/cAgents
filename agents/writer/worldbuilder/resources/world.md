> Mode `world` of `worldbuilder` — relocated verbatim from `agents/writer/worldbuilder/SKILL.md` (zero-loss consolidation).

# Worldbuilder — World Mode
...
### History as Worldbuilding Engine
...
### Sanderson's Third Law and Expansion
...
1. **Begin with theme**: What is this world *about*? What argument does it make? The world should embody and amplify the story's central tensions.
2. **Establish geography and climate**: The physical world constrains everything else. Draw rough geography, determine climate zones, identify resource distribution.
3. **Follow the resources**: Where is the food? The water? The ore? The magic? Resource distribution determines settlement patterns, trade routes, and conflict zones.
4. **Build cultures from daily life**: Start with what people eat, wear, and do — not with kings and gods. Work upward from the domestic to the political.
5. **Design power structures**: Who rules, how they maintain power, and what threatens it. Layer official and unofficial power.
6. **Create the magic or technology system**: Define rules, costs, limitations, and social consequences. Follow the implications honestly.
7. **Develop history as causation**: Events cause other events. Wars have economic causes. Religions emerge from cultural needs. Empires fall from internal contradictions.
8. **Submerge the iceberg**: You should know ten times what appears on the page. Imply depth through detail, reference, and specificity.
9. **Stress-test the world**: Ask adversarial questions. "Why hasn't someone exploited this?" "What prevents this system from collapsing?" "Who benefits from this arrangement?" If you can't answer, the world has a hole.

## The Worldbuilding Hierarchy

Build in this order — each layer depends on the ones below:
1. **Physics and cosmology** (rules of reality, magic axioms, celestial mechanics)
2. **Geography and ecology** (terrain, climate, resources, flora, fauna)
3. **Economics** (production, trade, currency, wealth distribution, labor)
4. **Political structure** (power, law, institutions, foreign relations)
5. **Social organization** (class, family, gender, education, outsiders)
6. **Culture** (daily life, customs, dress, food, art, entertainment)
7. **Religion and philosophy** (belief, ritual, theology, folk practice)
8. **Language and naming** (phonetic palettes, etymology, linguistic culture)
9. **History and lore** (eras, events, myths, legends, living memory)
10. **Story integration** (how all of the above serves the narrative)
...
- Every cultural detail implies a history — no arbitrary customs, no "planet of hats"
- Economic logic holds up under scrutiny — trade routes make geographic sense, currency reflects real value exchange
- Magic and technology have social consequences that have been followed honestly
- The world has more depth than the story reveals — the iceberg principle is visible
- Naming conventions are internally consistent within each culture
- Political structures have realistic tension points and failure modes
- The world's mood and personality amplify the story's themes
- Ecology, economics, culture, and politics interconnect — pulling one thread moves others
- Daily life is vivid and specific, not generic medieval European default

## Anti-Patterns

- **Planet of hats**: One trait per culture (the warrior race, the merchant race, the scholarly race). Real cultures are contradictory, layered, and internally diverse.
- **Medieval European default**: Castles, knights, taverns, and feudalism recycled without thought. If you're going to use medieval Europe, use *actual* medieval Europe — messy, strange, and nothing like the Renaissance Faire version.
- **Maps without logic**: Beautiful cartography with mountain ranges that make no geological sense, rivers that flow uphill, and cities in locations no one would actually settle.
- **Magic without cost**: If magic is free, every problem is trivially solvable. No cost means no drama, no tension, no interesting choices.
- **Technology without consequence**: Inventing gunpowder doesn't just give you cannons — it destroys the feudal military order, empowers centralized states, and makes castles obsolete. Follow the implications.
- **Worldbuilding as procrastination**: Building elaborate world bibles instead of writing the story. The world exists to serve the narrative. If a detail doesn't affect any character's experience, it's a hobby, not worldbuilding.
- **Monocultures**: An entire continent sharing one language, one religion, one political system. Earth has never worked this way, and neither should your world.
- **Aesthetic-only worldbuilding**: A world that looks cool but doesn't hold up to "why" questions. Why do they live in floating cities? How do they eat? Where does the waste go?
...
See @resources/world-world-bible.md for the comprehensive world bible framework.
See @resources/world-best-practices.md for design principles, patterns, and anti-patterns.
