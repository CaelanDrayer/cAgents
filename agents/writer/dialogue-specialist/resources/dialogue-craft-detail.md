# Dialogue Craft: Detailed Methodology

Deep technique catalogs for the dialogue specialist — dialogue theory, subtext methodology, character voice differentiation, dialogue patterns, dialogue mechanics, and period/genre conventions. The SKILL.md body keeps the core role and key principles; this file carries the full reference material.
