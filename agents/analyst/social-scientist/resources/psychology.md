> Mode `psychology` of `social-scientist` — relocated verbatim from `agents/analyst/psychologist/SKILL.md` (zero-loss consolidation).
...
- Crisis intervention (refer to mental-health-advisor for that)
