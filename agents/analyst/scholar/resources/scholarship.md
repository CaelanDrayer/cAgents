> Mode `scholarship` of `scholar` — relocated verbatim from `agents/analyst/scholar/SKILL.md` (zero-loss consolidation). The existing internal search/review/write structure is preserved intact below.
