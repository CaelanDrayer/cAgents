> Mode `strategy` of `strategic-planner` — relocated verbatim from `agents/strategic-planner.md` (zero-loss consolidation).

# Strategic Planner — Strategy Mode
...
See @resources/strategy-frameworks.md for strategic frameworks reference.

## Best Practices

See @resources/strategy-best-practices.md for design principles, patterns, anti-patterns, and quality indicators.
