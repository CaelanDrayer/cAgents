> Mode `code-review` of `qa-lead` — relocated verbatim from `agents/developer/quality/code-reviewer/SKILL.md` (zero-loss consolidation).
...
See @resources/code-review-scoring-rubrics.md for the language-specific anti-pattern enforcement tables (TypeScript/Python/JavaScript), the composite quality score, and the prose-quality review rubric for documentation/content.
...
See @resources/code-review-agent-selection.md for detection logic.
See @resources/code-review-auto-fix-patterns.md for fix generation.
See @resources/code-review-report-template.md for output format.
