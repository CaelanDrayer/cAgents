> Mode `customer-success` of `support-director` — relocated verbatim from `agents/operator/support/customer-success-manager/SKILL.md` (zero-loss consolidation).

# Support Director — Customer-Success Mode
...
See @resources/customer-success-customer-success-frameworks.md for onboarding and health monitoring patterns.
See @resources/customer-success-best-practices.md for design principles and anti-patterns.
