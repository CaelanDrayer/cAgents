> Mode `coordinate` of `support-director` — relocated verbatim from `agents/operator/support/support-director/SKILL.md` (zero-loss consolidation).

# Support Director — Coordinate Mode
...
See @resources/coordinate-support-leadership-frameworks.md for strategy templates and escalation protocols.
See @resources/coordinate-best-practices.md for design principles and anti-patterns.
