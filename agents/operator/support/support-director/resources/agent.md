> Mode `agent` of `support-director` — relocated verbatim from `agents/operator/support/support-agent/SKILL.md` (zero-loss consolidation).

# Support Director — Agent Mode
