> Mode `hr-ops` of `hr-manager` — relocated verbatim from `agents/operator/people-ops/hr-manager/SKILL.md` (zero-loss consolidation).
...
See @resources/hr-ops-hr-operations-framework.md for the HR service delivery model, onboarding/offboarding processes, policy development framework, and compliance calendar.

See @resources/hr-ops-employee-lifecycle-management.md for the full employee lifecycle (attract through alumni), performance management cycles, retention strategies, and career pathway frameworks.

See @resources/hr-ops-best-practices.md for design principles, patterns, frameworks, and anti-patterns for HR operations management.
