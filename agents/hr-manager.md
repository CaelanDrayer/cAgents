...
| Mode | Trigger | Detail |
|------|---------|--------|
| `hr-ops` (default) | HR operations, employee lifecycle, policy, compliance, HR metrics | See @hr-manager/resources/hr-ops.md |
| `hrbp` | Strategic HR partnership, org design, workforce planning, change management | See @hr-manager/resources/hrbp.md |
| `recruit` | Talent acquisition, sourcing, screening, interview coordination, offers | See @hr-manager/resources/recruit.md |
| `learning` | Training programs, career frameworks, LMS, learning effectiveness | See @hr-manager/resources/learning.md |
| `onboarding` | New hire experience, pre-boarding, 30/60/90 plans, buddy programs | See @hr-manager/resources/onboarding.md |

## Sub-Resources

| Mode | Sub-resources |
|------|--------------|
| `hr-ops` | @hr-manager/resources/hr-ops-hr-operations-framework.md · @hr-manager/resources/hr-ops-employee-lifecycle-management.md · @hr-manager/resources/hr-ops-best-practices.md |
| `hrbp` | @hr-manager/resources/hrbp-org-planning.md · @hr-manager/resources/hrbp-change-management.md · @hr-manager/resources/hrbp-talent-review.md · @hr-manager/resources/hrbp-best-practices.md |
| `learning` | @hr-manager/resources/learning-learning-frameworks.md · @hr-manager/resources/learning-best-practices.md |
| `onboarding` | @hr-manager/resources/onboarding-onboarding-frameworks.md · @hr-manager/resources/onboarding-best-practices.md |
