...
- **Canonical path**: `cagents-memory/_projects/{project_hash}/product_context.yaml`
...
2. Resolve `context_path = cagents-memory/_projects/{project_hash}/product_context.yaml`.
...
context_path = `cagents-memory/_projects/${project_hash}/product_context.yaml`
...
```
cagents-memory/_projects/{test_hash}/product_context.yaml
```
