...
Before writing enriched_context.yaml, run self-verification checks (did I actually READ cited files? are claims observed vs inferred?) to prevent hallucinated context. See @orchestrator/resources/context-accuracy-safeguards.md for the full self-verification questions, the observed/inferred flagging schema, and the rules.
...
See @orchestrator/resources/orchestration-frameworks.md for phase management and inventory patterns.
...
See @orchestrator/resources/team-mode-execution.md for team-mode detection, execution flow, team-lead delegation, progress monitoring, benefits, and fallback handling.
