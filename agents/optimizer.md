...
- `cagents-memory/_system/optimize/intent_patterns.yaml` — Intent parsing
- `cagents-memory/_system/optimize/framework_patterns.yaml` — Framework-specific patterns
- `cagents-memory/_system/optimize/scan_patterns.yaml` — Opportunity detection
...
See @optimizer/resources/parallel-execution.md for parallel execution strategy.
See @optimizer/resources/framework-patterns.md for framework-specific optimizations.
See @optimizer/resources/quality-gates.md for validation and rollback.
