> Mode `support-ops` of `support-director` — relocated verbatim from `agents/operator/support/support-operations-manager/SKILL.md` (zero-loss consolidation).

# Support Director — Support-Ops Mode
...
See @resources/support-ops-best-practices.md for design principles and anti-patterns.
