> Mode `market` of `market-research-analyst` — relocated verbatim from `agents/market-research-analyst.md` (zero-loss consolidation).
...
See @resources/market-frameworks.md for research methods and analysis patterns.

See @resources/market-best-practices.md for design principles and quality indicators.
