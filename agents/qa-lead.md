...
See @qa-lead/resources/coordinate.md for QA Lead coordination full playbook.
See @qa-lead/resources/code-review.md for code review full playbook.
See @qa-lead/resources/standards-audit.md for standards auditing full playbook.
See @qa-lead/resources/a11y.md for accessibility checking full playbook.
See @qa-lead/resources/playwright.md for Playwright test engineering full playbook.
