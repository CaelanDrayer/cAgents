...
design_documents:
  - ADR recorded in cagents-memory/{instruction_id}/decisions/architect_crdt_approach.yaml
...
review_request: |
  ...
  PLAN: cagents-memory/inst_20260103_009/workflow/plan.yaml
...
```yaml
# Outbound: cagents-memory/{instruction_id}/reviews/architecture_review_{timestamp}.yaml
