> Mode `ds` of `data-scientist` — relocated verbatim from `agents/data-scientist.md` (zero-loss consolidation).
...
See @resources/ds-data-science-frameworks.md for ML workflows and modeling patterns.
See @resources/ds-best-practices.md for design principles and quality indicators.
