> Mode `a11y` of `qa-lead` — relocated verbatim from `agents/developer/quality/accessibility-checker/SKILL.md` (zero-loss consolidation).
...
See @resources/a11y-wcag-requirements.md for WCAG 2.1 Level AA requirements.
See @resources/a11y-aria-patterns.md for correct ARIA usage.
See @resources/a11y-common-patterns.md for accessible code patterns.
