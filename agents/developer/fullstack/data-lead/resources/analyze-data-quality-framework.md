> Sub-resource for `analyze` mode — relocated verbatim from `agents/developer/fullstack/data-analyst/resources/data-quality-framework.md` (zero-loss consolidation).
