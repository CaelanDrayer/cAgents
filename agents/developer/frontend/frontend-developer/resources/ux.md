> Mode `ux` of `frontend-developer` — relocated verbatim from `agents/developer/frontend/ux-designer/SKILL.md` (zero-loss consolidation).
...
See @resources/ux-design-process.md for detailed methodology.
See @resources/ux-accessibility-checklist.md for WCAG compliance.
See @resources/ux-collaboration-patterns.md for team workflows.
...
**Writes**:
- `cagents-memory/{instruction_id}/decisions/{timestamp}_ux_designer.yaml`
