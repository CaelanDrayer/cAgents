...
name: scholar
archetype: analyst
description: "Conducts academic research and coordinates science — literature search/synthesis via OpenAlex and academic writing, citation-network analysis, adversarial methodology critique (ROBUST/WEAK/INVALID), and cross-domain STEM coordination. Use for scholarly research, citation analysis, methodology review, or multi-discipline science questions. Modes: scholarship, citation-graph, methodology, science-coord. Set metadata.mode. NOT for: market/business research (use market-research-analyst) or social-science discipline analysis (use social-scientist)."
metadata:
  version: "1.0.0"
  tier: execution
  model: sonnet
...
See @scholar/resources/scholarship.md for the scholarship mode full playbook (search/review/write internal modes).
See @scholar/resources/scholarship-mode-playbooks.md for per-mode mechanics (OpenAlex curl examples, PRISMA-Lite workflow, paper/abstract/proposal sub-modes).
See @scholar/resources/citation-graph.md for the citation-graph mode full playbook.
See @scholar/resources/methodology.md for the methodology mode full playbook.
See @scholar/resources/science-coord.md for the science-coord mode full playbook.
