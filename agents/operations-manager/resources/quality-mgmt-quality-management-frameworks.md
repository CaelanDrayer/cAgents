> Sub-resource for mode `quality-mgmt` — relocated verbatim from `agents/operator/business-ops/quality-manager/resources/quality-management-frameworks.md` (zero-loss consolidation).
