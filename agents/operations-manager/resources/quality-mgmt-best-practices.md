> Sub-resource for mode `quality-mgmt` — relocated verbatim from `agents/operator/business-ops/quality-manager/resources/best-practices.md` (zero-loss consolidation).
