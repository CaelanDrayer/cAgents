> Mode `analyze` of `data-lead` — relocated verbatim from `agents/developer/fullstack/data-analyst/SKILL.md` (zero-loss consolidation).
...
See @resources/analyze-pipeline-patterns.md for ETL/ELT design.
See @resources/analyze-analytics-best-practices.md for query optimization.
See @resources/analyze-data-quality-framework.md for quality assurance.
See @resources/analyze-best-practices.md for design principles and frameworks.
