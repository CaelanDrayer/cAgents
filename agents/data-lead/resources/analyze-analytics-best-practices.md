> Sub-resource for `analyze` mode — relocated verbatim from `agents/developer/fullstack/data-analyst/resources/analytics-best-practices.md` (zero-loss consolidation).
