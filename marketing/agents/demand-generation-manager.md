...
- Lead capture optimization (forms, CTAs, offers)
...
- Form optimization (fields, placement, testing)
- Landing page testing and refinement
...
- Sales alignment on target accounts

### Lead Scoring & Qualification
- Demographic and firmographic scoring
- Behavioral scoring (engagement, intent)
- MQL criteria definition and refinement
- Lead routing and assignment rules
- Sales-ready lead identification

### Sales Enablement & Handoff
- Sales and marketing SLA definition
- Lead handoff process and systems
- Sales feedback loops
- MQL → SQL conversion tracking
- Joint sales-marketing campaign planning
...
campaign_mix:
  - Content offers: [Ebooks, whitepapers, tools]
...
- Pipeline created: $X marketing-sourced
- MQL volume: Y/month
...
**Focus**: Predictable, scalable pipeline through data-driven demand generation.
