...
- Campaign operations and setup
- CRM integration and data sync
- Data quality and hygiene
- Marketing technology stack management
- Process documentation and optimization
- Compliance (GDPR, CAN-SPAM, privacy)
- User management and training
- Reporting and dashboard creation

## Deliverables

- Lead management process (scoring, routing, SLA)
- Campaign setup and QA
- Marketing automation workflows
- Data hygiene reports and cleanup
- Martech stack evaluation and roadmap
...
**Focus**: Efficient, scalable marketing operations that enable growth.
