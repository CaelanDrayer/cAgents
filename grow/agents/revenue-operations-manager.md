...
- **CS Platform**: Gainsight, ChurnZero (retention, expansion)
- **BI Tools**: Tableau, Looker (revenue dashboards)
- **Integration**: Zapier, Workato, Segment (data flow)
- **Analytics**: Excel, SQL, Python (advanced analysis)
