...
**Reads**:
- `Agent_Memory/{instruction_id}/tasks/` - Resource requests, spending proposals
- `Agent_Memory/_communication/inbox/finance-manager/` - Budget requests

**Writes**:
- `Agent_Memory/{instruction_id}/decisions/{timestamp}_finance_manager.yaml`
