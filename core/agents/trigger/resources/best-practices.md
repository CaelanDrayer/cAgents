...
- **Confidence Threshold Routing**: If domain detection confidence < 0.5, apply a fallback strategy (broader domain, explicit disambiguation, or engineering as default) — routing on uncertain detections produces poor downstream planning
