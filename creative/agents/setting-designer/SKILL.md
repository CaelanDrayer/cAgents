...
- **Dominant sense per scene**: Choose one sense to anchor the scene. Let others support it. A forge scene might be heat-dominant (the blast of the furnace, sweat running into eyes, metal too hot to touch without tongs) with sound as secondary (hammer-ring, hiss of quenching, the bellows' wheeze).
- **Synesthesia and cross-wiring**: The most memorable sensory details cross modalities. A color described as "loud." A silence that "tasted of metal." A texture that "sounded like old paper tearing." These surprise the reader into presence.
- **Sensory memory and association**: A smell doesn't just exist in the present — it reaches back in time. "The hallway smelled like every school hallway he'd ever walked down — floor wax and disinfectant and something underneath that might have been decades of cafeteria lunches absorbed into the walls."
- **Absence as sensation**: Sometimes the most powerful sensory detail is what's missing. The silence after an explosion. The absence of birdsong in a forest. The room that smells like *nothing* in a house that should smell like people.
- **The body in space**: Characters have bodies. They feel gravity, temperature, air pressure, the texture of what they're sitting on, the ache of standing too long. Grounding the reader in the character's physical experience is the fastest path to immersion.

### Pathetic Fallacy and Environmental Storytelling
...
### Genre-Specific Setting Conventions
...
1. **Determine the scene's emotional purpose**: What should the reader *feel* in this space? The setting serves the scene's emotional logic, not just its plot logic.
2. **Choose the dominant sense**: Which sensory channel will anchor this scene? Build outward from that sense.
3. **Select the telling details**: Three to five perfectly chosen, specific details are worth more than a paragraph of comprehensive description. Each detail should do double duty — establishing the physical space while implying character, history, or mood.
4. **Establish spatial relationships**: How does the character move through this space? Where are the entrances, exits, and barriers? What is close, what is far, what is above, what is below?
5. **Layer in temporal atmosphere**: What time of day? What season? What weather? How does light behave in this space?
6. **Connect to character perception**: The setting should be filtered through a specific consciousness. An anxious character notices the locked door, the narrow window, the distance to the exit. A grieving character notices the empty chair, the unwashed mug, the silence.
7. **Integrate, don't catalogue**: Weave sensory details into action and thought. The character doesn't stop to observe — they experience the setting while doing something and feeling something.

## Quality Standards

- Every setting detail does narrative work — establishes mood, reveals character, advances theme, or implies history
- Sensory details span at least three senses, with one dominant, integrated into action rather than listed
- The setting could not be swapped for a generic alternative without losing something essential to the scene
- Micro-details are specific enough to be photographed, not just imagined
- The space feels inhabited — with asymmetry, wear, accumulation, and the residue of past events
- Movement through space reveals character psychology
- The setting's emotional register matches or deliberately counterpoints the scene's dramatic register

## Anti-Patterns

- **The establishing shot**: A paragraph of pure description that stops the story dead while the camera pans across the setting. Settings should be experienced through action, not gazed at from a helicopter.
- **The sense catalogue**: "She saw the mountains. She heard the wind. She smelled pine." This is a list, not immersion. Integrate senses into a unified experience.
- **Generic decoration**: "The room was large with wooden furniture." This could be any room in any story. Specificity is everything.
- **Frozen settings**: Spaces that never change mood, weather, or light. Real spaces transform constantly — with time of day, with season, with the emotional state of the observer.
- **Exotic wallpaper**: Using unusual settings purely for visual interest without integrating them into character experience or thematic meaning. A floating city is decoration until someone is afraid of heights.
- **All eyes, no body**: Describing only what is seen, never what is felt, heard, smelled, or tasted. The reader has a body. Use it.
