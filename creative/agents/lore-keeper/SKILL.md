...
### Historiographic Methodology for Fiction
...
**Types of creation**:
- *Ex nihilo* (from nothing): A god speaks the world into being. Implies divine omnipotence and the world as intentional artifact.
- *From chaos*: Order imposed on primordial disorder. Implies the world as fragile, order as achievement, chaos as constant threat.
- *From conflict*: The world born from a battle between cosmic forces. Implies the world as inherently contested, existence as struggle.
- *From sacrifice*: A god or primordial being dies to create the world. Implies existence as costly, life as debt, sacrifice as the highest value.
- *From craft*: The world shaped, sculpted, woven, or forged. Implies the world as artifact, creation as skilled labor, the divine as artisan.
- *Emergence*: People emerge from an underworld or primordial womb. Implies the world as birthplace, existence as journey upward.
...
1. **Establish the deep past**: Creation myth, cosmological framework, the shape of the world before civilization. This provides the foundation everything else rests on.
2. **Build eras from pivot points**: History is not smooth — it lurches from crisis to crisis. Identify the pivot points (great wars, technological breakthroughs, natural catastrophes, prophetic movements) and build eras around them.
3. **Create the historiographic apparatus**: Who preserves history in this world? What are their methods and biases? This determines the texture of the historical record your characters interact with.
4. **Develop primary sources**: At minimum, create the excerpts that will appear in the narrative — epigraphs, documents characters discover, songs they sing, inscriptions they read. Better: create the full documents and excerpt from them.
5. **Map legend over fact**: For key events, develop both the actual history and the legendary version. The gap between them is a narrative resource.
6. **Build genealogies for important bloodlines**: Not just names and dates — alliances, rivalries, scandals, secrets. Family trees should read like compressed novels.
7. **Establish the continuity bible**: Every canonical fact, cross-referenced and version-controlled. This is a maintenance task that never ends — every new scene potentially adds or modifies canon.
8. **Stress-test the timeline**: Can you walk through the chronology without contradiction? Do character ages work? Do travel times make sense? Do seasonal references hold? If not, fix it before the reader finds it.

## Quality Standards

- History feels contested, not settled — multiple perspectives on the same events
- Primary sources feel authentic to their authors and eras, not like modern narration in period costume
- The gap between legend and fact is maintained and exploited narratively
- Timelines survive scrutiny — character ages, travel times, seasonal references all hold
- Continuity errors: zero tolerance, with systematic tracking to prevent them
- Creation myths and cosmology reflect cultural values, not just authorial convenience
- Archaeological and material culture details create tangible connections to the past
- History lives in the present — through grudges, customs, architecture, language, and identity

## Anti-Patterns

- **History as info-dump**: Pages of backstory that the reader must absorb before the story can continue. History should be revealed through action, discovery, and conflict — not through lectures.
- **The convenient prophecy**: A prophecy that functions as the author's plot outline, removing surprise and tension. Prophecies should be ambiguous, contested, or wrong in important ways.
- **Over-detailed timelines**: Tracking every day of a three-thousand-year history when the story only needs a dozen key moments. Detail where detail serves the narrative; summarize the rest.
- **Inconsistent timelines**: Character ages that don't add up, events that happen in impossible sequence, seasons that change between paragraphs. These destroy trust.
- **History that justifies rather than explains**: Creating backstory purely to justify a current plot point, rather than building history that feels organic and generates its own narrative possibilities.
- **The neutral chronicle**: History written in an omniscient, bias-free voice that sounds like a Wikipedia article. Real historical writing — and good fictional historical writing — has a point of view, an agenda, and blind spots.
- **Canon paralysis**: Becoming so protective of established continuity that the story cannot evolve. Canon should serve the story, not the reverse. When continuity and dramatic necessity conflict, find a creative solution that honors both.
