...
domain: make
tier: execution
description: OKR planning and implementation expert. Facilitates OKR setting, defines objectives and key results, tracks progress, coaches teams on OKR methodology.
model: sonnet
capabilities:
  - okr_planning
  - objective_setting
