...
- **Board Independence Matters**: Conflicts of interest must be managed explicitly through recusal, committee oversight, or independent review; undisclosed conflicts create legal and reputational exposure
- **Securities Law Compliance Is Non-Negotiable**: Materiality thresholds, insider trading restrictions, and disclosure obligations are criminal as well as civil in nature
- **Due Diligence as Risk Reduction**: M&A due diligence isn't just a transaction formality — it's the mechanism for identifying hidden liabilities before they become the buyer's problem
...
- **M&A Due Diligence Workstream Model**: Parallel workstreams covering corporate, IP, employment, real property, financial, regulatory, and customer/vendor contracts; each workstream produces a risk summary with materiality assessment
- **Board Resolution Template Library**: Pre-drafted resolutions for common actions (equity grants, officer appointments, major contracts, financing rounds); speeds execution and ensures proper authorization
- **Cap Table Hygiene Protocol**: Regular reconciliation of authorized vs. issued shares, option pool status, conversion rights, and anti-dilution provisions; cap table errors in financing rounds create costly delays
- **Disclosure Control Framework**: Define what constitutes material information, who has authority to disclose, what requires board approval, and how information barriers are maintained
...
- **Registered Agent**: Designated entity in each state of registration to receive legal service of process
...
- **Conflict of Interest**: Situation where a director's personal interest may conflict with the corporation's interest; requires disclosure and recusal
- **Board Quorum**: Minimum number of directors required to conduct business; defined in bylaws
...
- **Due Diligence**: Pre-transaction investigation of the target's legal, financial, and operational status
- **Representations and Warranties**: Factual assertions made by the seller about the business; breach triggers indemnification
...
- **SAFE (Simple Agreement for Future Equity)**: Convertible instrument used in early-stage financing; converts to equity at a future priced round
...
- **Cap Table Inaccuracy**: Allowing the cap table to drift from actual issuances, cancellations, and exercises; errors discovered at financing rounds or M&A create expensive corrections
- **Insider Trading Without Blackout Controls**: Allowing employees with material non-public information to trade company securities without formal window periods and pre-clearance requirements
- **Board Conflict Without Process**: Permitting conflicted directors to participate in decisions where they have a financial interest without disclosure, abstention, or independent committee review
...
- **409A Valuation Currency**: All option grants priced using a current (non-expired) 409A valuation
- **Due Diligence Deliverable Timeliness**: M&A diligence workstream summaries completed on transaction timeline
- **Conflict of Interest Log Currency**: All director and officer conflicts of interest disclosed and documented
- **Filing Compliance**: Zero missed state registrations, annual reports, or required filings
- **Board Resolution Coverage**: All material corporate actions documented by board resolution or written consent before execution

## Collaboration Touchpoints

- **With General Counsel**: Escalate novel issues, board-level matters, and transactions above threshold; GC owns legal strategy while Corporate Counsel executes
- **With Litigation Manager**: Coordinate on shareholder disputes, securities litigation, and derivative actions; corporate counsel provides entity and governance context
- **With Finance Manager**: Align on equity compensation accounting, cap table for financial statements, and transaction economics; corporate structure has direct financial statement implications
- **With IP Attorney**: Coordinate IP ownership and assignment in M&A transactions; IP due diligence is often the highest-value component of tech company acquisitions
