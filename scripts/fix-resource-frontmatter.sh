...
"$PROJECT_ROOT/engineering/agents/devops-engineer/resources/container-orchestration.md"
"$PROJECT_ROOT/engineering/agents/devops-engineer/resources/iac-patterns.md"
...
"$PROJECT_ROOT/engineering/agents/code-reviewer/resources/report-template.md"
